...
public class CameraPreviewWithTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public CameraPreviewWithTextureView(Context context, CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public CameraPreviewWithTextureView(Context context, AttributeSet attrs,  CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(cameraWrapper, previewCallback);
    }
...
//        showCameraPreview(surface);
    ...
    public void showCameraPreview(SurfaceTexture surfaceTexture) {
        if(mCameraWrapper != null) {
            try {
                ...
                mCameraWrapper.mCamera.setPreviewTexture(surfaceTexture);
    ...
    public void showCameraPreview() {
        if(mCameraWrapper != null && surfaceTexture != null) {
            try {
                //getHolder().addCallback(this);
                setSurfaceTextureListener(this);
                mPreviewing = true;
