...
public abstract class BarcodeScannerViewWithTextureView extends FrameLayout implements Camera.PreviewCallback {

    private CameraWrapper mCameraWrapper;
    private CameraPreviewWithTextureView mPreview;
    ...
    public BarcodeScannerViewWithTextureView(@NonNull Context context) {
        super(context);
        init();
    }

    public BarcodeScannerViewWithTextureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public final void setupLayout(CameraWrapper cameraWrapper) {
        ...
        mPreview = new CameraPreviewWithTextureView(getContext(), cameraWrapper, this);
